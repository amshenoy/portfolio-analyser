...
function update_simplots(stocks, sim_data, total_amount) {
	...
	//////////////////Parallel Plot//////////////////////////
	///////////////////////////////////////////////////////////////
	var parallel_data = allocate ? stock_counts : portfolios;
...
$(document).ready(function () {
	...
	$("#simulate").click(function () {
		...
		var longshort = $("#longshort").is(":checked");
		var free_rate = $("#free-rate").val() / 100; // free interest growth
	
		simulator.postMessage([assets, main_data, free_rate, total_amount, prune, longshort]);
	});
